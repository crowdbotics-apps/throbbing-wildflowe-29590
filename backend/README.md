...
## Project Structure
    ...
    ├── throbbing_wildflowe_29590  # Django project configurations
...
1. Clone this repo and `cd throbbing_wildflowe_29590`
...
2. Clone this repo and `cd throbbing_wildflowe_29590`
